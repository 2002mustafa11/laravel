...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset('admin') }}/docs/assets/css/adminlte.min.css">
  <!-- overlayScrollbars -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('admin') }}/docs/assets/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('min/'. $user->id. '/edit') }}" class="nav-link">recover-password</a>
      </li>
...
<!-- AdminLTE App -->
<script src="{{ asset('admin') }}/docs/assets/js/adminlte.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{ asset('admin') }}/docs/assets/js/demo.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('admin') }}/docs/assets/js/pages/dashboard.js"></script>
</body>
</html>
