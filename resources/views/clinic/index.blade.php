...
<head>
    ...
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.1/css/bootstrap.rtl.min.css"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
    <link rel="stylesheet" href="{{ asset('clinic') }}/assets/styles/pages/main.css">
...
<body>
    <div class="page-wrapper">
        <nav class="navbar navbar-expand-lg navbar-expand-md bg-blue sticky-top">
            <div class="container">
                <div class="navbar-brand">
                    <a class="fw-bold text-white m-0 text-decoration-none h3" href="{{ asset('clinic') }}/index.html">VCare</a>
                </div>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="d-flex gap-3 flex-wrap justify-content-center" role="group">
                        <a type="button" class="btn btn-outline-light navigation--button" href="{{ asset('clinic') }}/index.html">Home</a>
                        <a type="button" class="btn btn-outline-light navigation--button"
                            href="{{ asset('clinic') }}/majors.html">majors</a>
                        <a type="button" class="btn btn-outline-light navigation--button"
                            href="{{ asset('clinic') }}/doctors/index.html">Doctors</a>
                        <a type="button" class="btn btn-outline-light navigation--button" href="{{ asset('clinic') }}/login.html">login</a>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <div class="container pb-5">
                <div class="row gap-2">
                    <div class="col-sm order-sm-2">
                        <img src="{{ asset('clinic') }}/assets/images/banner.jpg" class="img-fluid banner-img banner-img" alt="banner-image"
                            height="200">
                    </div>
        ...
        <div class="container">
            ...
            <div class="d-flex flex-wrap gap-4 justify-content-center">
                <div class="card p-2" style="width: 18rem;">
                    <img src="{{ asset('clinic') }}/assets/images/major.jpg" class="card-img-top rounded-circle card-image-circle"
                        alt="major">
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center">Major title</h4>
                        <a href="{{ asset('clinic') }}/doctors/index.html" class="btn btn-outline-primary card-button">Browse Doctors</a>
                    </div>
                </div>
                <div class="card p-2" style="width: 18rem;">
                    <img src="{{ asset('clinic') }}/assets/images/major.jpg" class="card-img-top rounded-circle card-image-circle"
                        ...
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                ...
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    ...
                                    <a href="{{ asset('clinic') }}/doctors/doctor.html" class="btn btn-outline-primary card-button">Book an
                                        appointment</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="splide__slide">
                            <div class="card p-2" style="width: 18rem;">
                                ...
                                <div class="card-body d-flex flex-column gap-1 justify-content-center">
                                    <h4 class="card-title fw-bold text-center">Doctor Name</h4>
                                    <h6 class="card-title fw-bold text-center">Major</h6>
                                    <a href="{{ asset('clinic') }}/doctors/index.html" class="btn btn-outline-primary card-button">Browse
                                        Doctors</a>
                                </div>
                            </div>
                        </li>
        ...
        <div class="banner container d-block d-lg-grid d-md-block d-sm-block">
            ...
            <div class="bottom--right bg-blue text-white">
                <img src="{{ asset('clinic') }}/assets/images/banner.jpg" class="img-fluid banner-img">
            </div>
        </div>
    </div>
        ...
        <div class="row gap-2">
            ...
            <div class="col-sm order-sm-2">
                ...
                <div class="links d-flex gap-2 flex-wrap">
                    <a href="{{ asset('clinic') }}/index.html" class="link text-white">Home</a>
                    <a href="{{ asset('clinic') }}/majors.html" class="link text-white">Majors</a>
                    <a href="{{ asset('clinic') }}/doctors/index.html" class="link text-white">Doctors</a>
                    <a href="{{ asset('clinic') }}/login.html" class="link text-white">Login</a>
                    <a href="{{ asset('clinic') }}/register.html" class="link text-white">Register</a>
                    <a href="{{ asset('clinic') }}/contact.html" class="link text-white">Contact</a>
                </div>
            </div>
        </div>
    </footer>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <script src="{{ asset('clinic') }}/assets/scripts/home.js"></script>
</body>
